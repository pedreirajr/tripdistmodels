...
-   **The Furness growth factor model (Iterative Proportional Fitting - IPF)** to update a base OD to future productions and attractions.
-   **The synthetic Gravity model** calibrated to match the **trip length frequency distribution (TLFD)** of a base OD matrix.
...
If you use **tripdistmodels** in academic work, consider citing the package repository and release version you used.
